...
public  class miknatiseksihareket : MonoBehaviour
{
    Rigidbody2D fizik;
    public float hiz;
    bool kontrol = false;
    ...
    void FixedUpdate()
    {
        ...
        if (!kontrol)
        {
            fizik.MovePosition(fizik.position + Vector2.up * Time.fixedDeltaTime * hiz);
